        ...
        if(reader.name() == "root"){
            while(reader.readNextStartElement()){
                if(reader.name() == "Engineering"){
                        ...
                        if(type == "Mechanics"){
                            lista.append(new Mechanical_Engineering(sname.toStdString(),snum.toStdString(),fname.toStdString(),
                                                                  loc.toStdString(),entry.toInt(),degree.toStdString(),math.toInt(),logic.toInt()));
                             qDebug()<<"Letto" + sname+snum+loc+degree+logic+math+loc;
                        }

                        if(type == "Informatic"){
                                lista.append(new Computer_Engineering(sname.toStdString(),snum.toStdString(),fname.toStdString(),
                                                                      loc.toStdString(),entry.toInt(),degree.toStdString(),math.toInt(),logic.toInt()));
                                 qDebug()<<"Letto" + sname+snum+loc+degree+logic+math;
                        }
                        ...
                        if(type == "Aeronautic"){
                            ...
                            reader.readNextStartElement();
                                ...
                                lista.append(new Aeronautic(sname.toStdString(),snum.toStdString(),fname.toStdString(),
                                                                      loc.toStdString(),entry.toInt(),degree.toStdString()
                                                            ,math.toInt(),logic.toInt(),laurea.toStdString(),
                                                            laureasco.toInt(),esamsco.toInt()));

                                 qDebug()<<"Letto" + sname+fname+snum+loc+degree+logic+math+laurea+laureasco+esamsco;
                        }
