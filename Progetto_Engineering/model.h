...
public:
    ...
    bool admission(string fac, int a, int b)const;
    int CountFaculties()const;
    const Engineering* getFaculty(int)const; // return the faculty of the specify index
    void settext(const string&,const string&, const string&, const string&, int, const string&, int, int,
                 const string&, int, int);
    Container<Engineering*>searchStudent(const string& student)const;
